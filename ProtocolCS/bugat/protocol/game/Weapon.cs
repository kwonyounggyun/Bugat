...
public struct Weapon : IFlatbufferObject
{
  ...
  public static Offset<bugat.protocol.game.Weapon> CreateWeapon(FlatBufferBuilder builder,
  ...
  public static Offset<bugat.protocol.game.Weapon> EndWeapon(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<bugat.protocol.game.Weapon>(o);
  }
}
